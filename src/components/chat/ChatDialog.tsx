...
Отвечай дружелюбно и профессионально на русском и кыргызском языке. отвечай не слишком длинно не все любят много читать`,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md w-[min(100vw,420px)] h-[600px] p-0">
        <div className="flex flex-col h-full min-h-0">
          <DialogHeader className="px-4 py-3 border-b flex items-center justify-between">
          ...
          <div ref={scrollRef} className="flex-1 overflow-y-scroll px-4 py-4 space-y-4">
